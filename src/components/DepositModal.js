...
function DepositModal({img,name}) {
  ...
  return (
    <>
    <button onClick={() => setOpenModal(true)} className="bg-purple-600 py-4 px-6 rounded-lg text-white hover:bg-purple-700 ">Deposit</button>
