...
const reserve = () => {
  return (
    <>
    <div className='bg-[#091326]  h-screen '>
      ...
      <div className='flex mt-3  w-full justify-between lg:justify-evenly px-6 '>
       <div >
        <p className='text-gray-300 text-[14px] font-normal '>Price</p>
        <p className='text-white mt-2 text-[18px]'>$1</p>
       </div>
       <div >
        <p className='text-gray-300 text-[14px] font-normal '>Supply APY</p>
        <p className='text-green-400 mt-2 text-[18px]'>22%</p>
       </div>
       <div >
